...
class _AuthScreenState extends State<AuthScreen> {
  ...
  esqueciMinhaSenhaClicado() {
    ...
    showDialog(
      context: context,
      builder: (context) {
        TextEditingController redefinicaoController =
            TextEditingController(text: email);
        return AlertDialog(
          title: const Text('Confirme o email para redefinicao de senha'),
          ...
          actions: [
            TextButton(
              onPressed: () {
                authService
                    .redefinicaoSenha(email: redefinicaoController.text)
                    .then((String? erro) {
                  if (erro != null) {
                    showSnackbar(context: context, mensagem: erro);
                  }
